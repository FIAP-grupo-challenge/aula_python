...
def indentificar_lingua(lingua):
	codigo = None
	lista_l = linguas["data"]["languages"]
	for item in lista_l:
		if item["name"] == lingua:
			codigo = item["code"]
	return codigo

def traduzir(texto, lingua_origem, lingua_destino):
	url = "https://google-translate1.p.rapidapi.com/language/translate/v2"

	payload = {
		"q": f"{texto}",
		"target": f"{indentificar_lingua(lingua_destino)}",
		"source": f"{indentificar_lingua(lingua_origem)}"
	}
	headers = {
		"content-type": "application/x-www-form-urlencoded",
		"Accept-Encoding": "application/gzip",
		"X-RapidAPI-Key": "ab41924355msh4dc81d6cfe95a5dp15349cjsn6be12aead594",
...
print(traduzir("danilo eh um bom professor de python","Portuguese","English"))
